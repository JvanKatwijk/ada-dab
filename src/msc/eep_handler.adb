...
begin
	...
	if (uint16_t (Object. protLevel) and 8#0100#) /= 0 -- set A profile
	then
	...
	elsif (uint16_t (Object. protLevel) and 8#0200#) /= 0	-- B series
	then
	   case Object. protLevel mod 8 is
	      when 4	=>
...
procedure Free_viterbi_data is new Ada. Unchecked_Deallocation (
